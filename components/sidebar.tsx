    ...
    return (
      <Listbox
        ...
        itemClasses={{
          ...itemClasses,
          base: cn(
            "px-2 min-h-11 rounded-large h-[44px] data-[selected=true]:bg-default-100",
            itemClasses?.base,
          ),
          title: cn(
            "font-medium text-lg px-2 text-default-500 group-data-[selected=true]:text-foreground",
            itemClasses?.title,
          ),
        }}
        items={items}
