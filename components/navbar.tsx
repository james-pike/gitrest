...
<Modal
  classNames={{
    ...
    wrapper: "sm:items-start sm:justify-start items-start max-w-[80%] fixed inset-0", // Set wrapper to fixed and inset-0
    body: "p-0",
...
>
        <ModalContent>
          <ModalBody>
            <div className="relative rounded-lg border-2 border-default-100 flex h-full w-78 flex-1 flex-col p-5">
