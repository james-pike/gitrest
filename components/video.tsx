            ...
            return (
              ...
              <Image
                    ...
                    <div className="absolute top-1/2 left-1/4 transform -translate-x-1/4 -translate-y-1/2 z-20 space-y-3">
                        ...
                        <button className="bg-white text-black font-bold py-3 border-white border-1 px-4 rounded mr-2 text-xs">ORDER ONLINE</button>
                        <button className="bg-white text-black font-bold py-3 border-white border-1 px-4 rounded mr-2 text-xs">BOOK RESERVATION</button>
                    </div>
                </div>
            );
        }